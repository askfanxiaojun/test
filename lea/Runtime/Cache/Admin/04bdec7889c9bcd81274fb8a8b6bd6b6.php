...
<div class="x12 padding ">
	...
	<div class="x6 padding-bottom">
		<form action="/index.php?s=/Admin/User/index.html" method="get" >
	...
	<table class="table table-bordered table-hover text-small">
		<tbody>
			<tr>
				...
				<th>名字</th>
				<th>
					<?php if($_GET['money'] != 'asc'): ?><a href="/index.php?s=/Admin/User?money=asc" class="text-blue">余额 <span class="icon-caret-down"></span></a>
						<?php else: ?>
			...
			<?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr  class="height">
					<td>
						<?php if($vo['header']): ?><img src="<?php echo ($vo["header"]); ?>" width="50" /><?php endif; ?>
					</td>
					<td ><?php echo ($vo["phone"]); ?></td>
					<td><?php echo ($vo["name"]); ?> (  <?php if($vo['sex'] == '1'): ?>男<?php elseif($vo['sex'] == '2'): ?>女<?php else: ?>未知<?php endif; ?> )
					</td>
					<td><a href="/index.php?s=/Admin/Funds/money_details/uin/<?php echo ($vo["uin"]); ?>" class="text-sub">￥<?php echo ($vo["money"]); ?> 元</a></td>
					<td><a href="###" class="text-sub"><?php echo ($vo["points"]); ?></a></td>
					<td><a href="/index.php?s=/Admin/Item/index/uin/<?php echo ($vo["uin"]); ?>" class="text-sub"><?php echo ($vo["item"]); ?> 个</a></td>
					<td><a href="javascript:void(0)" onclick="iframe('/index.php?s=/Admin/Investor/lead/uin/<?php echo ($vo["uin"]); ?>')"  class="text-sub"><?php echo ($vo["itemLead"]); ?> 个</a></td>
					<td><a href="/index.php?s=/Admin/Item/index/uin/<?php echo ($vo["uin"]); ?>" class="text-sub"><?php echo ($vo["questions"]); ?> 个</a></td>
					<td><a href="javascript:void(0)" onclick="iframe('/index.php?s=/Admin/Investor/interview_item/uin/<?php echo ($vo["uin"]); ?>')" class="text-sub"><?php echo ($vo["interview"]); ?> 个</a></td>
					<td><a href="javascript:void(0)" onclick="iframe('/index.php?s=/Admin/Investor/collect_item/uin/<?php echo ($vo["uin"]); ?>')"  class="text-sub"><?php echo ($vo["investor"]); ?> 个</a></td>
