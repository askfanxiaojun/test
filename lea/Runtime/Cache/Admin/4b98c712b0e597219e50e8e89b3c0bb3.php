...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bupt): $mod = ($i % 2 );++$i;?><div class="x12 bg padding">
		...
		<div class="x9 bg padding bg-white border-left height-big">
			...
			<span class="x6 text-right"><button class="button radius-none bg-red" target="_blank"><?php echo ($bupt["progress_name"]); ?></button>
			...
			<div class="x12">
				...
				<a href="javascript:void(0)" onclick="delitem('<?php echo U('Admin/Item/item_del',array('id'=>$bupt['id'],'isdel'=>0));?>')" class="radius-none button button-small bg-sub">还原</a>
