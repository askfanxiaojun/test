...
<html lang="zh-cn">
<head>
	<title><?php echo ($bupt["title"]); ?> - BUPT众筹</title>
	...
	<div class="container">
		...
		<div class="x12 margin-top">
			...
			<div class="x8 padding-right">
				...
				<div class="tab">
					<div class="x12">
						<span class="x12 bg-red text-white padding-big text-center height-big"><h3><?php echo ($bupt["title"]); ?></h3></span>
						<span class="text-small text-gray bg-white padding float-right" style="margin-top:9px">发布时间：<?php echo (date("m-d",$bupt["time"])); ?></span>
					</div>
